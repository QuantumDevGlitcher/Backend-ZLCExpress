...
exports.RFQValidationMiddleware = void 0;
class RFQValidationMiddleware {
    /**
     * Validar datos de creación de RFQ
     */
    static validateCreateRFQ(req, res, next) {
        const errors = [];
        const data = req.body;
        // Validar productId
     ...
     */
    static validateRFQResponse(req, res, next) {
        const errors = [];
        const data = req.body;
        // Validar supplierId
...
exports.RFQValidationMiddleware = RFQValidationMiddleware;
