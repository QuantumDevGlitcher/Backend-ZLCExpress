    ...
    static getAllCategories() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const categoriesWithSubs = mainCategories.map(mainCat => (Object.assign(Object.assign({}, mainCat), { subcategories: mockCategories.filter(cat => cat.parentId === mainCat.id) })));
...
class ProductService {
    static getAllProducts() {
        return __awaiter(this, arguments, void 0, function* (filters = {}) {
            try {
                ...
                if (filters.searchQuery) {
                    ...
                    filteredProducts = filteredProducts.filter(product => {
                        ...
                        return product.name.toLowerCase().includes(query) ||
                            ...
                            ((_a = product.tags) === null || _a === void 0 ? void 0 : _a.some(tag => tag.toLowerCase().includes(query)));
                    });
                }
                // Filtro por tipo de contenedor
                if (filters.containerType) {
                    filteredProducts = filteredProducts.filter(product => product.containerType === filters.containerType);
                }
                // Filtro por rango de precios
                if (filters.priceMin !== undefined) {
                    filteredProducts = filteredProducts.filter(product => product.pricePerContainer >= filters.priceMin);
                }
                if (filters.priceMax !== undefined) {
                    filteredProducts = filteredProducts.filter(product => product.pricePerContainer <= filters.priceMax);
                }
                // Filtro por stock disponible
                if (filters.inStock) {
                    filteredProducts = filteredProducts.filter(product => product.stockContainers > 0);
                }
                // Filtro por estado
                if (filters.status) {
                ...
                const enrichedProducts = yield Promise.all(paginatedProducts.map((product) => __awaiter(this, void 0, void 0, function* () {
                    const category = mockCategories.find(cat => cat.id === product.categoryId);
                    ...
                    return Object.assign(Object.assign({}, product), { category: category, supplier: supplierData, volumeDiscounts });
                })));
                return {
    ...
    static getProductsByCategory(categoryId_1) {
        return __awaiter(this, arguments, void 0, function* (categoryId, filters = {}) {
            return this.getAllProducts(Object.assign(Object.assign({}, filters), { categoryId }));
        });
    }
    static searchProducts(query_1) {
        return __awaiter(this, arguments, void 0, function* (query, filters = {}) {
            return this.getAllProducts(Object.assign(Object.assign({}, filters), { searchQuery: query }));
        });
    }
    // Métodos para suppliers
    static getProductsBySupplierId(supplierId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield new Promise(resolve => setTimeout(resolve, 200));
