...
export class FreightValidationMiddleware {
   ...
   */
  static validateFreightCalculation(req: Request, res: Response, next: NextFunction): void {
   ...
   */
  static validateStatusUpdate(req: Request, res: Response, next: NextFunction): void {
   ...
   */
  static validateConfirmation(req: Request, res: Response, next: NextFunction): void {
   ...
   */
  static rateLimitFreightCalculations(req: Request, res: Response, next: NextFunction): void {
   ...
   */
  static logFreightOperation(req: Request, res: Response, next: NextFunction): void {
