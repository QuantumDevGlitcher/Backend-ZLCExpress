...
// Interfaz para las especificaciones del producto
...
export interface ProductFilters {
  ...
  sortBy?: 'name' | 'price' | 'pricePerContainer' | 'createdAt' | 'totalViews';
  sortOrder?: 'asc' | 'desc';
}

export class ProductService {
  static async getAllProducts(filters?: ProductFilters): Promise<{ success: boolean; products: any[]; total: number }> {
    try {
      const {
        page = 1,
        limit = 20,
